...
import dev.zio.quickstart.ExampleData.*
import dev.zio.quickstart.ExampleService.ExampleService
...
object ExampleApi {
  ...
  case class Mutations(
      deleteCharacter: CharacterArgs => URIO[ExampleService, Boolean]
  )

  case class Subscriptions(
      characterDeleted: ZStream[ExampleService, Nothing, String]
  )
